	...
	<div>
		<div class="portlet-body">
			<div class="control-group" style='margin-top:20px;'>
				<span class='dec'>
					物联卡号<span class='symbol'>*</span>
				</span>
				<Input v-model="numberOfCard" placeholder="" style="width: 300px"></Input>
				<span class='error_text' v-if='numberOfCardError'>{{numberOfCardText}}</span>
			</div>
			...
			<div class="control-group">
				...
				<span class='error_text' v-if='iccidError'>{{iccidText}}</span>
			</div>
			<div class="control-group">
				<span class='dec'>
					物联卡类型
				</span>
				<Select v-model="cardType" :disabled = 'isEdit' style="width:300px" @on-change = 'cardTypeChange'>
			...
			<div class="control-group">
				...
				<Select v-model="defaultStockState" :disabled = 'isEdit' style="width:300px" @on-change = 'stockStateChange'>
